      ...
      >
        <div className="canvas">
          ...
          <div id="card" className="text-gray-800 dark:text-gray-800">
            ...
            <div className="title flex flex-col justify-around items-center h-full">
              <div className="font-bold p-2 text-sm md:text-lg ">{title}</div>
              <div className="font-thin text-xs md:text-md lg:text-lg">
                {description}
              </div>
              <div className="w-full flex justify-center space-x-2 items-center p-4">
                <div className="flex gap-x-2 items-center">
                  <IoBookOutline className="text-balance" />
                  {readTime}
                </div>
